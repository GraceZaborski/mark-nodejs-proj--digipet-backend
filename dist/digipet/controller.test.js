...
describe("rehomeDigipet", () => {
    test("when there is a digipet, it is rehomed.", () => {
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        const digipet = controller_1.rehomeDigipet();
        expect(digipet).toStrictEqual(undefined);
        expect(model_1.setDigipet()).toStrictEqual(undefined);
    });
});
...
describe("ignoreDigipet", () => {
    it("decreases digipet happiness, discipline and nutrition by 10", () => {
        // setup
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        expect(model_1.getDigipet()).toStrictEqual(model_1.INITIAL_DIGIPET);
        // act
