...
describe("GET /digipet/rehome", () => {
    test("if the user has no digipet, respond about hatching one", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.setDigipet(undefined);
        const response = yield supertest_1.default(server_1.default).get("/digipet/rehome");
        expect(response.body.message).toMatch(/hatch/i);
    }));
    test("if the user has a digipet, rehome it", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        const response = yield supertest_1.default(server_1.default).get("/digipet/rehome");
